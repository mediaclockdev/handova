                ...
                <form id="propertiesForms" action="{{ route('admin.properties.update', $property) }}" method="POST"
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3 mt-2 d-flex flex-wrap" id="preview-container">
                                @php
                                    $floorPlans = is_string($floorPlans) ? json_decode($floorPlans, true) : $floorPlans;
                                @endphp
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-12">
                            ...
                            <select class="form-select select2 @error('appliance_id') is-invalid @enderror"
                                ...
                                <option value="0" {{ in_array(0, $selectedAppliances) ? 'selected' : '' }}>
                                    No Appliances
                                </option>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('tags') is-invalid @enderror" id="tags"
                                ...
                                <option value="featured"
                                    {{ old('tags', $property->tags ?? '') == 'featured' ? 'selected' : '' }}>Featured
                                </option>
                                <option value="luxury"
                                    {{ old('tags', $property->tags ?? '') == 'luxury' ? 'selected' : '' }}>Luxury
                                </option>
                            </select>
                            @error('tags')
                                <div class="text-danger">{{ $message }}</div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" value="{{ old('internal_notes', $property->internal_notes) }}"
