        ...
        <div id="login-container" class="w-full max-w-md">
            <div id="login-card" class="bg-white rounded-lg border border-neutral-200 shadow-sm p-8">
                <div id="login-header" class="text-center mb-8">
                    ...
                    <h1 class="text-2xl text-neutral-900 mb-2">Reset Password</h1>
                    <p class="text-neutral-600 text-sm">Enter your email address and we'll send you a link to reset your password</p>
                </div>

                <form id="login-form" class="space-y-6" method="POST" action="{{ route('superadmin.password.email') }}">
                    @csrf
                ...
                <div id="back-to-login" class="mt-6 text-center">
                    <span class="text-sm text-neutral-600">Remember your password? </span>
                    <a href="{{ route('superadmin.login') }}" class="forgot_password">
                        <span class="text-sm text-neutral-900 hover:text-neutral-700 cursor-pointer">
                            Back to Login
                        </span>
                    </a>
                </div>

                <div id="help-section" class="mt-8 pt-6 border-t border-neutral-200">
                    <div class="bg-neutral-50 rounded-md p-4">
                        <div class="flex items-start space-x-3">
                            <div class="flex-shrink-0">
                                <i class="text-neutral-600" data-fa-i2svg=""><svg class="svg-inline--fa fa-circle-info" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="circle-info" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
                            ...
                            <div class="flex-1">
                                <h3 class="text-sm text-neutral-900 mb-1">Need help?</h3>
                                <p class="text-xs text-neutral-600 mb-2">If you don't receive the reset email within 5 minutes, please check your spam folder or contact support.</p>
                                <span class="text-xs text-neutral-900 hover:text-neutral-700 cursor-pointer">Contact Support</span>
                            </div>
                        </div>
                    </div>
                </div>
