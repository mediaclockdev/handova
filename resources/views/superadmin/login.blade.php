        ...
        <div id="login-container" class="w-full max-w-md">
            <div id="login-card" class="bg-white rounded-lg border border-neutral-200 shadow-sm p-8">
                <div id="login-header" class="text-center mb-8">
                    ...
                    <h1 class="text-2xl text-neutral-900 mb-2">Super Admin Login</h1>
                    <p class="text-neutral-600 text-sm">Enter your credentials to access the admin panel</p>
                </div>

                <form id="login-form" class="space-y-6" method="POST" action="{{ route('superadmin.login.submit') }}">
                    @csrf
                    <div id="email-field" class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input type="email" id="email" name="email" class="block w-full pl-10 pr-3 py-3 border border-neutral-300 rounded-md bg-white text-neutral-900 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:border-transparent" placeholder="Enter your email or username" required="">
                        </div>
                    </div>

                    <div id="password-field" class="space-y-2">
                        <label for="password" class="block text-sm text-neutral-900">Password</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            ...
                            <input type="password" id="password" name="password" class="block w-full pl-10 pr-10 py-3 border border-neutral-300 rounded-md bg-white text-neutral-900 placeholder-neutral-500 focus:outline-none focus:ring-2 focus:ring-neutral-900 focus:border-transparent" placeholder="Enter your password" required="">
                    ...
                    <div id="remember-forgot" class="flex items-center justify-between">
                        <div class="flex items-center">
                            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 text-neutral-900 focus:ring-neutral-900 border-neutral-300 rounded">
                            <label for="remember-me" class="ml-2 block text-sm text-neutral-700">
                                Remember me
                            </label>
                        </div>
                        <div class="text-sm">
                            <a class="forgot_password" href="{{ route('superadmin.password.request') }}">
                                <span class="text-neutral-900 hover:text-neutral-700 cursor-pointer">
                                    Forgot password?
                                </span>
                            </a>
                        </div>
                    ...
                    <div id="login-button" class="space-y-4">
                        <button type="submit" class="w-full flex justify-center items-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm text-white bg-neutral-900 hover:bg-neutral-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-900">
                            <i class="mr-2" data-fa-i2svg=""><svg class="svg-inline--fa fa-right-to-bracket" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="right-to-bracket" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
