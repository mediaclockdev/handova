<div class="row g-4 mb-4">
    <div class="col-md-12">
        ...
        <input type="text" name="house_owner_id" class="form-control @error('house_owner_id') is-invalid @enderror"
    ...
    <div class="mb-3">
        <label for="properties_id" class="form-label">Select Property <span style="color:red;">*</span></label>
...
<div class="row g-4 mb-4">
    <div class="col-md-6 mb-3">
        <label>Handover Documents</label>
        ...
        <div class="mt-2 d-flex flex-wrap" id="handover-preview">
            ...
            @foreach ($handoverDocs as $doc)
                ...
                <div class="position-relative m-2 text-center img-thumbnail">
                    ...
                    <input type="hidden" name="existing_handover_documents[]" value="{{ $doc }}">
        ...
        <div class="mt-2 d-flex flex-wrap" id="floorplan-preview">
            ...
            @foreach ($floorPlans as $plan)
                <div class="position-relative m-2 img-thumbnail">
                    ...
                    <input type="hidden" name="existing_floor_plan_upload[]" value="{{ $plan }}">
                    <button type="button" class="close-btn" onclick="removeExistingImage(this)">
                        <i class="fa fa-times"></i>
                    </button>
                </div>
