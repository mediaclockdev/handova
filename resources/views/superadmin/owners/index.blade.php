        ...
        <div class="main-content flex-grow-1">
            <div class="">
                <div class="dashboard-content">
                    <div id="page-header" class="mb-6">
                        <div class="max-w-7xl mx-auto">
                            <div class="mb-8">
                                <h2 class="text-2xl text-neutral-900 mb-2">Owners Management</h2>
                                <p class="text-neutral-600">View, filter, and manage all registered Owners</p>
                            </div>
                            <div id="search-filtersss" class="bg-white rounded-lg border border-neutral-200 p-6 mb-6">
                                <form method="GET" action="{{ route('superadmin.owners.index') }}">
                                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">

                                        <div class="md:col-span-2">
                                            <label class="block text-sm text-neutral-700 mb-2">Search House
                                                Owner</label>
                                        ...
                                        <div>
                                            <div>
                                                <label class="block text-sm text-neutral-700 mb-2">Property
                                                    Listing</label>
                                                <select name="property_id" class="w-full px-3 py-2 border rounded-md">
                                    ...
                                    <div class="flex justify-between items-center mt-4">
                                        <div class="flex space-x-2">
                                            ...
                                            <a href="{{ route('superadmin.owners.export', request()->query()) }}"
                                                class="px-4 py-2 border border-neutral-300 text-neutral-700 rounded-md hover:bg-neutral-50">
                                                <i class="mr-2" data-fa-i2svg="">
                ...
                <div id="builders-table" class="bg-white rounded-lg border border-neutral-200 overflow-hidden mb-8">
                    <form id="bulkActionForm" method="POST" action="{{ route('superadmin.properties.bulkAction') }}">
                        @csrf
                ...
                <div id="stats-overview" class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white rounded-lg border border-neutral-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-neutral-500">Total House Owners</p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="grid grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                            <strong>Propery Details:</strong>
                            <p id="properydetails"></p>
                        </div>

                        <div>
                            <strong>Address Of Property:</strong>
                            <p id="addressofproperty"></p>
                        </div>
                        ...
                        <div>
                            ...
                            <p id="internalnotes"></p>
                        </div>

                        <div class="col-span-2">
                            <strong>Handover Documents:</strong>
                            <div id="handoverdocuments" class="grid grid-cols-3 gap-3 mt-2 flex"></div>
                        </div>

                        <div class="col-span-2">
                            <strong>Floor Plan Upload:</strong>
                            <div id="floorplanupload" class="grid grid-cols-3 gap-3 mt-2 flex"></div>
                        </div>
