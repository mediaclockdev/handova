            ...
            <div class="">
                <div class="dashboard-content">
                    <div id="page-header" class="mb-6">
                        <div class="flex justify-between items-center">
                            <div>
                                ...
                                <p class="text-neutral-600">Update subscription plans for your platform</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="subscription-form" class="bg-white rounded-lg border border-neutral-200 p-6">
                        ...
                        <form action="{{ route('superadmin.plans.update', $plan->id) }}" method="POST" class="space-y-6">
                            @csrf @method('PUT')
                            @include('superadmin.plans.form', ['plan' => $plan])
