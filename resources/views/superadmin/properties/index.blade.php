                ...
                <div id="builders-table" class="bg-white rounded-lg border border-neutral-200 overflow-hidden mb-8">
                    ...
                    <div class="overflow-x-auto">
                                ...
                                @if ($properties->count())
                                    @foreach ($properties as $propertie)
                                        <tr class="hover:bg-neutral-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="text-sm text-neutral-900">{{ $loop->index + $properties->firstItem() }}</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="text-sm text-neutral-900">{{ $propertie->created_at }}</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                    ...
                                                    <a href="javascript:void();"
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            data-baseurl="{{ asset('') }}"
                                                            data-floorplanupload='@json($propertie->floor_plan_upload)'
                        ...
                        <div class="mt-6 flex justify-center">
                            {{ $properties->links('vendor.pagination.numbers-only') }}
                        </div>
