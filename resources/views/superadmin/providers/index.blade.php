                                ...
                                @if ($users->count())
                                    @foreach ($users as $user)
                                        <tr class="hover:bg-neutral-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="text-sm text-neutral-900">{{ $user->company_name }}</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    class="text-sm text-neutral-900">{{ $user->service_type }}</span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex space-x-2">
                                                    ...
                                                    {{-- Suspend --}}
                                                    <form
                                                        action="{{ route('superadmin.providers.suspend', $user->id) }}"
                                                    ...
                                                    <form
                                                        action="{{ route('superadmin.providers.destroy', $user->id) }}"
